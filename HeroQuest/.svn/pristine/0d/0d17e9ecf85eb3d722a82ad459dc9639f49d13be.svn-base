/* This class is used to create maps for Hero Quest.  All data will be written to
 * XML files. 
 * All pieces of data are represented as numbers, and these numbers are stored in a 2D array
 */
...
namespace HeroQuest.Maps
{
    class Board
    {
        /***********graphics************
         * All graphics are 60x60 pixels. 
         */
        ...
        //variables
        const int GRID_ROWS = 19;
        const int GRID_COLS = 26;
        
        public const int NUM_LEVELS = 50; //maximum number of levels in HQ. There are 14 quests in the original game
        ...
        public Board(Texture2D playerTexture, Texture2D normalTileTexture, Texture2D emptyTileTexture, SpriteFont font)
        {
            ball = playerTexture;

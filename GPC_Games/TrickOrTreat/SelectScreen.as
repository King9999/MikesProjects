/* This is the costume select screen. The player can view a description of what the costume does before
making a selection. */
...
package  
{
	...
	public class SelectScreen extends MovieClip 
	{
		...
		public function SelectScreen() 
		{
			...
			_selectIcon.push(new P1Select());
			_selectIcon.push(new P2Select());
			...
			"when you wear a cute costume! Don't try to use a trick, though.";
			
			_costumeText[3].text = "WITCH: With her magic wand, she can use tricks from " + 
